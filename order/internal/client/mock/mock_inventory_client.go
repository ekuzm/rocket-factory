...
func (_mock *InventoryClient) ListParts(ctx context.Context, filter model.Filter) ([]model.Part, error) {
...
func (_c *InventoryClient_ListParts_Call) Run(run func(ctx context.Context, filter model.Filter)) *InventoryClient_ListParts_Call {
...
func (_c *InventoryClient_ListParts_Call) RunAndReturn(run func(ctx context.Context, filter model.Filter) ([]model.Part, error)) *InventoryClient_ListParts_Call {
	_c.Call.Return(run)
	return _c
}
