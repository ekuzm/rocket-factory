...
type tracerConfig struct{ raw tracerEnvConfig }

func (tc *tracerConfig) ServiceName() string                 { return tc.raw.ServiceName }
func (tc *tracerConfig) Endpoint() string                    { return tc.raw.Endpoint }
func (tc *tracerConfig) ServiceVersion() string              { return tc.raw.ServiceVersion }
func (tc *tracerConfig) DeploymentEnvironment() string       { return tc.raw.DeploymentEnvironment }
func (tc *tracerConfig) Compressor() string                  { return tc.raw.Compressor }
func (tc *tracerConfig) RetryEnabled() bool                  { return tc.raw.RetryEnabled }
func (tc *tracerConfig) RetryInitialInterval() time.Duration { return tc.raw.RetryInitialInterval }
func (tc *tracerConfig) RetryMaxInterval() time.Duration     { return tc.raw.RetryMaxInterval }
func (tc *tracerConfig) RetryMaxElapsedTime() time.Duration  { return tc.raw.RetryMaxElapsedTime }
func (tc *tracerConfig) Timeout() time.Duration              { return tc.raw.Timeout }
