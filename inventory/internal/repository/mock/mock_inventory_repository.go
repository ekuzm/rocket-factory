...
import (
	...
	model0 "github.com/ekuzm/rocket-factory/inventory/internal/repository/model"
)
...
func (_mock *InventoryRepository) GetPart(ctx context.Context, uuid string) (model.Part, error) {
...
//   - ctx context.Context
//   - uuid string
func (_e *InventoryRepository_Expecter) GetPart(ctx, uuid interface{}) *InventoryRepository_GetPart_Call {
...
func (_c *InventoryRepository_GetPart_Call) RunAndReturn(run func(ctx context.Context, uuid string) (model.Part, error)) *InventoryRepository_GetPart_Call {
	_c.Call.Return(run)
	return _c
}

// ListParts provides a mock function for the type InventoryRepository
func (_mock *InventoryRepository) ListParts(ctx context.Context, filter model0.Filter) ([]model.Part, error) {
	...
	var r0 []model.Part
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, model0.Filter) ([]model.Part, error)); ok {
		return returnFunc(ctx, filter)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, model0.Filter) []model.Part); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, model0.Filter) error); ok {
...
func (_c *InventoryRepository_ListParts_Call) Run(run func(ctx context.Context, filter model0.Filter)) *InventoryRepository_ListParts_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 model0.Filter
		if args[1] != nil {
			arg1 = args[1].(model0.Filter)
		}
		run(
			arg0,
			arg1,
...
func (_c *InventoryRepository_ListParts_Call) RunAndReturn(run func(ctx context.Context, filter model0.Filter) ([]model.Part, error)) *InventoryRepository_ListParts_Call {
	_c.Call.Return(run)
	return _c
}
