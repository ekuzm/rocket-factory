...
func (_mock *InventoryService) ListParts(ctx context.Context, filter model.Filter) ([]model.Part, error) {
...
func (_c *InventoryService_ListParts_Call) RunAndReturn(run func(ctx context.Context, filter model.Filter) ([]model.Part, error)) *InventoryService_ListParts_Call {
	_c.Call.Return(run)
	return _c
}
